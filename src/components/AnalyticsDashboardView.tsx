...
export const AnalyticsDashboardView: React.FC<AnalyticsDashboardViewProps> = ({
  ...
  return (
    <div className="min-h-screen bg-slate-950 bg-animated-gradient flex items-center justify-center p-3 sm:p-6 md:p-8 font-sans selection:bg-indigo-500 selection:text-white">
      <div className="max-w-3xl w-full glass-card rounded-[2.5rem] p-5 sm:p-8 relative border border-slate-700/60 shadow-2xl text-left">
        ...
        {/* 🏆 1. Tier & XP Hero Card */}
        <div className="bg-gradient-to-br from-indigo-950/60 via-slate-900 to-slate-900/90 rounded-3xl p-6 border border-indigo-500/30 shadow-md mb-6 relative overflow-hidden">
          ...
          <div>
            <div className="flex justify-between text-[11px] font-black text-slate-400 mb-1.5">
              ...
              <span className="text-indigo-300">{tierInfo.progress}% {language === 'en' ? 'Achieved' : '달성'}</span>
            ...
            {tierInfo.capNotice && (
              <div className="mt-3 px-3.5 py-2 rounded-xl bg-amber-500/20 border border-amber-500/40 text-amber-200 text-xs font-black flex items-center gap-2 shadow-sm">
                <span>🔒</span>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6">
          <div className="bg-slate-950/80 p-4 rounded-2xl border border-slate-800 text-center shadow-sm">
        ...
        <div className="mb-6 space-y-3">
          <div className="flex items-center justify-between">
            ...
            <span className="text-xs text-indigo-300 font-black bg-indigo-500/10 px-2.5 py-1 rounded-md border border-indigo-500/30">
              10 Topics
            </span>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {PRACTICAL_GRAMMAR_CATEGORIES.map((cat) => (
              <div
                key={cat.id}
                className="bg-slate-950/80 border border-slate-800 hover:border-indigo-400/60 p-4 rounded-2xl transition-all shadow-sm flex flex-col justify-between"
              >
                <div>
        ...
        <div className="bg-gradient-to-r from-indigo-950/40 via-purple-950/30 to-slate-900 border border-indigo-500/30 rounded-3xl p-5 sm:p-6 shadow-sm">
