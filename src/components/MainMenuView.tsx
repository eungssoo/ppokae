      ...
      <div className="max-w-3xl w-full glass-card rounded-[2.5rem] p-5 sm:p-8 relative border border-slate-700/60 shadow-2xl">
        ...
        <div className="flex flex-wrap items-center justify-between gap-2.5 mb-5 border-b border-slate-700/60 pb-3.5">
          <div className="flex flex-wrap items-center gap-1.5 sm:gap-2">
            {/* ⚡ App Brand Badge */}
            <div className="flex items-center gap-1.5 px-3 py-1 rounded-full bg-indigo-500/20 border border-indigo-500/40">
              <span className="text-xs sm:text-sm">⚡</span>
              <span className="text-xs font-black text-indigo-300 font-sans tracking-wide">
            ...
            <button
              ...
              className="flex items-center gap-1.5 bg-slate-800/90 hover:bg-slate-750 border border-slate-700/80 px-2.5 sm:px-3 py-1 rounded-full shadow-sm transition-all active:scale-95 text-left"
              title={t('myProfile')}
            >
            ...
            {/* 🪙 코인 잔액 배지 */}
            <div className="flex items-center gap-1 bg-amber-500/15 border border-amber-500/40 px-2.5 py-1 rounded-full shadow-sm">
          ...
          <div className="flex items-center gap-1.5 ml-auto">
            ...
            <button
              ...
              className="flex items-center gap-1 px-2.5 py-1.5 rounded-xl bg-slate-800/90 hover:bg-slate-750 border border-slate-700/80 hover:border-cyan-400 text-slate-200 hover:text-white font-black text-xs shadow-sm active:scale-95 transition-all"
            ...
            {onOpenInquiryModal && (
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-slate-800/90 hover:bg-slate-750 border border-slate-700/80 hover:border-indigo-400 text-slate-200 hover:text-white font-bold text-xs shadow-sm active:scale-95 transition-all"
                title="문의 및 피드백"
              >
        ...
        <div className="mb-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <button
              ...
              className="group p-4 sm:p-5 bg-slate-850 hover:bg-rose-500/10 border border-slate-700/80 hover:border-rose-500/40 rounded-2xl transition-all shadow-sm hover:shadow-md text-left flex flex-col justify-between"
            >
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  ...
                  <ArrowRight className="w-3.5 h-3.5 text-slate-400 group-hover:text-rose-400 group-hover:translate-x-1 transition-all" />
                </div>
            ...
            <button
              ...
              className="group p-4 sm:p-5 bg-slate-850 hover:bg-amber-500/10 border border-slate-700/80 hover:border-amber-500/40 rounded-2xl transition-all shadow-sm hover:shadow-md text-left flex flex-col justify-between"
            >
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  <div className="flex items-center gap-1.5">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 mb-2.5">
            ...
            <button
              ...
              className="p-3.5 bg-slate-850 hover:bg-indigo-500/10 border border-slate-700/80 hover:border-indigo-400 rounded-2xl transition-all text-left flex items-center justify-between shadow-sm group active:scale-[0.98]"
            >
              <div>
            ...
            <button
              ...
              className="p-3.5 bg-slate-850 hover:bg-amber-500/10 border border-slate-700/80 hover:border-amber-400 rounded-2xl transition-all text-left flex items-center justify-between shadow-sm"
            >
              <div>
                <div className="flex items-center gap-1.5 mb-0.5">
              ...
              <ArrowRight className="w-3.5 h-3.5 text-slate-400 group-hover:text-amber-400 transition-colors" />
            </button>
          ...
          <div className="grid grid-cols-3 gap-2">
            <button
              ...
              className="p-2.5 bg-slate-900/80 hover:bg-slate-800 border border-slate-750 rounded-xl transition-all text-center shadow-sm"
            >
            ...
            <button
              ...
              className="p-2.5 bg-slate-900/80 hover:bg-rose-500/15 border border-slate-750 hover:border-rose-500/40 rounded-xl transition-all text-center shadow-sm"
            >
            ...
            <button
              ...
              className="p-2.5 bg-slate-900/80 hover:bg-amber-500/15 border border-slate-750 hover:border-amber-500/40 rounded-xl transition-all text-center shadow-sm"
            >
