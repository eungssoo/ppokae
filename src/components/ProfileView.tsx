        ...
        <div className="bg-gradient-to-br from-indigo-900/70 via-purple-950/85 to-slate-900/95 rounded-3xl p-5 sm:p-6 border border-purple-500/40 shadow-md mb-5 relative overflow-hidden">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 relative z-10">
            ...
            <button
              ...
              className="w-full sm:w-auto px-6 py-3.5 bg-gradient-to-r from-pink-500 via-purple-500 to-amber-500 hover:from-pink-600 hover:to-amber-600 text-white font-black text-xs sm:text-sm rounded-2xl shadow-[0_10px_30px_rgba(236,72,153,0.3)] transition-all active:scale-95 flex items-center justify-center gap-2 border border-pink-400/50"
            >
                      ...
                      {isUnlocked ? (
                        isEquipped ? (
                          ...
                          <button
                            ...
                            className="w-full py-1.5 bg-purple-600 hover:bg-purple-700 text-white rounded-xl text-[11px] font-black shadow-sm transition-all active:scale-95 flex items-center justify-center gap-1"
                          >
          ...
          <div className="bg-gradient-to-br from-indigo-950/90 via-purple-950/80 to-slate-900/90 border border-indigo-500/40 rounded-2xl p-4 mb-5 text-left shadow-sm relative overflow-hidden">
            ...
            {onLinkGoogleAccount && (
              <button
                ...
                className="w-full py-3 bg-white hover:bg-slate-100 text-slate-900 rounded-xl font-black text-xs sm:text-sm flex items-center justify-center gap-2 transition-all shadow-sm active:scale-95 border border-slate-300"
              >
        ...
        <form onSubmit={handleNicknameSubmit} className="bg-slate-900/80 rounded-2xl p-3.5 sm:p-4 border border-slate-800 mb-5 shadow-sm">
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className="px-4 py-2.5 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 disabled:opacity-40 disabled:grayscale text-white rounded-xl font-black text-xs sm:text-sm transition-all active:scale-95 flex items-center gap-1 shrink-0 shadow-sm"
            >
