...
export const TRANSLATIONS = {
  ko: {
    ...
    weaknessHeroTitle: '취약점 분석 & 테마별 실전 풀이',
    weaknessHeroDesc: 'AI 정밀 진단 리포트 및 10대 문법 테마별 집중 문제 풀이',
  ...
  en: {
    ...
    weaknessHeroTitle: 'Grammar Weakness Analysis & Practice',
    weaknessHeroDesc: 'AI diagnostics across 10 grammar topics and targeted theme practice',
